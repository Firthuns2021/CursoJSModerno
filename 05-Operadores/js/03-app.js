...
console.log('let numero>',numero); // La variable esta definida pero su valor no, por lo tanto es undefined...
console.log(typeof numero)
let numero1= 20;
console.log('let numero1>',numero1);
// En el caso de null es más bien asignarlo

let numero2 = null;
console.log('let numero2 = null>', numero2);
