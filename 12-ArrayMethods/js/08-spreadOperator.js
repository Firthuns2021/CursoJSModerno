...
// Si tienes 2 arreglos los unes como vimos en el video anterior, pero digamos que tienes
// un arreglo y quieres añadir un elemento al final que es un string utilizarias...

const meses2 = [...meses, 'Julio'];
console.log(meses);
console.log(meses2); // Recuerda esto no modifica el arreglo original como si haria push y
