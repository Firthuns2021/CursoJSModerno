...
/* VIDEO 10 ESLINT PARA SOLUCIONES ERRORES DE CÓDIGO *
...
/** ejercicio quitamos los ';' del final de cada linea y ejecuta el comando ...
 *    eslint js/app.js _>>> apareciendonos el siguiente mensajes por consola:
 *
 * 48:37  error  Missing semicolon  semi
 49:18  error  Missing semicolon  semi
 52:26  error  Missing semicolon  semi
 55:61  error  Missing semicolon  semi
 56:19  error  Missing semicolon  semi
 59:28  error  Missing semicolon  semi
 62:32  error  Missing semicolon  semi
 81:20  error  Missing semicolon  semi
 82:21  error  Missing semicolon  semi

 ✖ 9 problems (9 errors, 0 warnings)
 9 errors and 0 warnings potentially fixable with the `--fix` option.

 * eslint js/app.js --fix -> reescribe el codigo y nos coloca los ';' faltantes
 * */
